...
$pdf->Cell(0,7,'Laporan Spesialis',0,1,'C');
...
$pdf->Cell(35,6,'Id Spesialis',1,0,'C');
$pdf->Cell(35,6,'Nama Spesialis',1,1,'C');

$pdf->SetFont('Arial','',10);
$no=1;
foreach ($spesialis as $data){
    $pdf->Cell(8,6,$no,1,0);
    $pdf->Cell(35,6,$data['id_spesialis'],1,0,'C');
    $pdf->Cell(35,6,$data['nama_spesialis'],1,1,'C');
    $no++;
}
$pdf->Output();
?>