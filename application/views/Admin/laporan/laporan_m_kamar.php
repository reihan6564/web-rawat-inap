...
$pdf->Cell(30,6,'No Kamar',1,0,'C');
$pdf->Cell(35,6,'Nama Kamar',1,0,'C');
$pdf->Cell(30,6,'Kelas Kamar',1,0,'C');
$pdf->Cell(30,6,'Status Kamar',1,1,'C');

$pdf->SetFont('Arial','',10);
$no=1;
foreach ($kamar as $data){
    $pdf->Cell(8,6,$no,1,0);
    $pdf->Cell(30,6,$data['no_k'],1,0,'C');
    $pdf->Cell(35,6,$data['nama_k'],1,0,'C');
    $pdf->Cell(30,6,$data['kelas_k'],1,0,'C');
    $pdf->Cell(30,6,$data['status_k'],1,1,'C');
    $no++;
}
$pdf->Output();
?>